...
\lstloadlanguages{[ANSI]C, C++, [gnu]make, gnuplot, Matlab, Python, JavaScript}
...
%sowie die verschiedenen Open Source Implementierungen von \ac{OPC UA}, zum Beispiel die C++ Implementierung \emph{open62541} \cite{open62541} oder die Python Implementierung \emph{Python OPC-UA} \cite{pythonopcua2018}.
...
%Erstellung eines eigenen Buttons der steigende Flanke beim drücken ausgibt und fallende beim loslassen des Tasters. 
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.7\linewidth]{/Users/Makki/Documents/candy-grabber/StateMachine.png}
...
%Programmierung des Ablaufs für Remote Bedienung über Server und Node-RED Flow.
\subsection{Benutzerschnittstelle}
...
%\rowcolor[gray]{0.8}Dokumentation\\\hline
Versionsverwaltung & Kommentare im Code & Bachelorarbeit\\\hline
\end{tabular}
\end{table}
%Mockswitch sollte über Berechnungen erstellt werden. Dies wurde nicht mehr umgesetzt, stattdessen bleibt MockSwitch Signal False.
%
\clearpage
...
\begin{figure}[H]
\centering
\includegraphics[width=0.7\linewidth]{/Users/Makki/Documents/candy-grabber/ClassDiagram_CG.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\linewidth]{/Users/Makki/Documents/candy-grabber/activity_diagram_cg.png}
\caption{UML Aktivitätendiagramm des Candy Grabbers}\label{fig:uml_activity}
\end{figure}
%
\begin{figure}[H]
\centering
\includegraphics[width=\linewidth]{./PICs/mods_2.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.7\linewidth]{./PICs/mod_motor.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=1.2\linewidth, angle=270]{./PICs/nodered_flow_cg.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=1.2\linewidth, angle=270]{./PICs/dashboard.png}
